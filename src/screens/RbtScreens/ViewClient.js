...
import {
    ...
    DialogContent, DialogTitle, TextField, MenuItem, FormHelperText, Toolbar, IconButton, TablePagination, Checkbox, TableContainer
} from '@material-ui/core';
import Card from '@material-ui/core/Card';
import { fetchClients } from '../../actions/clientAction'
//import {  assignProgram } from '../../actions/clientAction'
...
class ViewClient extends Component {
    ...
    //     let { client_id, program_id, mode } = this.state
    ...
    //         }
    //         else {
    //             // this.props.dispatch(updateProgram(this, programObj, id))
    //         }
    //     }
    // }
    ...
    //     // console.log("======2315355785======" + JSON.stringify(category))
    //     return (data.map((e) =>
        ...
        return (
            <div style={{ margin: 5 }}>
                <Grid container justify="center">
                    <Grid item xs={12}>
                        {filteredClient !== null && _.isEmpty(filteredClient) !== true && <Typography className={classes.headerTextStyle} style={{ padding: 5 }}>{filteredClient.userProfile.first_name} {filteredClient.userProfile.last_name}</Typography>}

                        <Toolbar style={{ justifyContent: "space-between", padding: "0px 0px 0px 0px", marginTop: -10 }}>
                            <Typography style={{ color: "gray", fontFamily: "Futura-Heavy", fontWeight: "bold", fontSize: 20, paddingLeft: 5 }}>{"Assigned Programs"} </Typography>
                            <TablePagination
                        ...
                        <Dialog
                            ...
                            <DialogContent style={{ overflowY: "hidden" }}>
                                ...
                                {this.state.trials.length <= 10 && <Toolbar style={{ justifyContent: "space-between", padding: "5px 20px 10px 10px" }}>
                                    <Typography style={{ color: "#2687C4", fontFamily: "Futura-Heavy", fontWeight: "bold", fontSize: 20, padding: 10 }}>Trails</Typography>
